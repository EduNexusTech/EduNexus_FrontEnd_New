    ...
    <section className="w-full py-20 sm:py-28">
      ...
      >
        ...
        <div className="relative mx-auto max-w-4xl">
          ...
          <h2 className="mx-auto mt-8 text-3xl font-extrabold text-[var(--lp-text)] sm:text-4xl lg:text-5xl xl:text-6xl">
            Ready to deliver an extraordinary learning experience with EduNexus?
          </h2>
          <p className="mx-auto mt-6 max-w-2xl text-base font-semibold text-[var(--lp-muted)] lg:text-lg">
